...
/**
 * This is the general Scan Manager exception class for all operations dealing with Scan Manager.
 */
public class ScanManagerException extends Exception {
     ...
     */
    public ScanManagerException(String message) {
        super(message);
    }
