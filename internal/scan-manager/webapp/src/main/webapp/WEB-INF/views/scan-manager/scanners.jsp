                        ...
                        && !staticScanners.get(0).id.equals('')}">
                            <div class="jumbotron"
                                ...
                                <c:forEach begin="0" end="${staticScanners.size()-1}"
                                    ...
                                    <c:out
                                            value="${staticScanners.get(index).name}"></c:out>
                                    <br>
                                </c:forEach>
                            </div>
                        </c:if>
                        ...
                        && !dynamicScanners.get(0).id.equals('')}">
                            <div class="jumbotron"
                                ...
                                <c:forEach begin="0" end="${dynamicScanners.size()-1}"
                                    ...
                                    <c:out
                                            value="${dynamicScanners.get(index).name}"></c:out>
                                    <br>
                                </c:forEach>
                            </div>
                        </c:if>
                    ...
                    <c:if test="${dependencyScanners.size() > 0}">
                        ...
                        && !dependencyScanners.get(0).id.equals('')}">
                            <div class="jumbotron"
                                ...
                                <p>Dependency</p>
                                <c:forEach begin="0"
                                           end="${dependencyScanners.size()-1}"
                                           var="index">
                                    <input type="radio" name="scannerId"
                                           value="${dependencyScanners.get(index).id}"
                                           checked> <c:out
                                        value="${dependencyScanners.get(index).name}"></c:out>
                                    <br>
                                </c:forEach>
                            </div>
                        </c:if>
