...
/**
 * Model class to represent a scan priority update request.
 */
public class ScanPriorityUpdateRequest {

    private ScanPriority priority;

    public ScanPriorityUpdateRequest() {
    }

    public ScanPriorityUpdateRequest(ScanPriority priority) {
