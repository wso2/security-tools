...
public class MavenBuildReceiver {
    ...
    /**
     * This method is used to get the maven build version of the product
     * @param file pom.xml path
     * @return returning the build version
     */
    public static String getPomVersion(File file)
    {
        ...
        try {
            DocumentBuilderFactory dbFactory
                    = JiraSecurityManager.getSecuredDocumentBuilderFactory();
