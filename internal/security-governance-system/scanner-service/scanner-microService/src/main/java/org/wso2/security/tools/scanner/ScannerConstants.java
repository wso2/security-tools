...
/**
 * ScannerConstants of the application.
 */
public final class ScannerConstants {
    ...
    public static final String VERACODE_USERNAME = "veracode_user";
    public static final String VERACODE_PASSWORD = "veracode_password";
