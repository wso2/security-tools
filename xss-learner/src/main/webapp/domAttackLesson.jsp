                    ...
                    <div class="col-xs-4">
                        ...
                        <blockquote>
                            ...
                            <pre id="RightCode">
                                <code>
                                    String name = request.getParameter( <span style="color: #3a802d ">query"</span> );
                                    document.getElementById("post-container").innerHTML="Hello "+&lt;%= <span style="color: orange" >Encode.<i>forHtml</i></span>((name)) %>+" !";
                                </code>
                            </pre>
                        </blockquote>
                        <h4>If you want to try out this code enter a query to search</h4>
                        <form method="get" action="domAttackRightPage.jsp">
                            Enter the vulnerable script here: <input name="query" value="" type="text">
                            <input type="submit" value="Submit" />
                        </form>
                    </div>
...
<div>
    <form action="domAttackWrongPage.jsp" method="get">
