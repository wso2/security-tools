        ...
        <html>
            ...
            <body>
                <div id="front-page">
                    ...
                    <div id="head">
                        <h2>Dependency check Report for1
                            <br/>
                            <br/>
                            <xsl:value-of select="/dc:analysis/dc:projectInfo/dc:name"/>
                        </h2>
                        <h3 style="margin-top:50px;">Version:
                            <br/>
                            <br/>
                            <xsl:value-of select="/dc:analysis/dc:projectInfo/dc:version"/>
                        </h3>
                    ...
                    <div id="info">
                        <div>
                            ...
                            <span id="report-date">
                                <xsl:value-of select="substring(/dc:analysis/dc:projectInfo/dc:reportDate,1,10)"/>
                            </span>
                        </div>
                        <div>
                ...
                <xsl:for-each select="/dc:analysis/dc:dependencies/dc:dependency">
                    <xsl:if test="dc:vulnerabilities/dc:vulnerability">
                        <div>
                            <h3>
                                <xsl:value-of select="dc:fileName"/>
                            </h3>
                        </div>
                        <div>
                            ...
                            <table>
                                ...
                                <xsl:for-each select="dc:vulnerabilities/dc:vulnerability">
                                    ...
                                    <xsl:variable name="mappingNodeVul"
                                                  select="concat('https://cve.mitre.org/cgi-bin/cvename.cgi?name=',dc:name)"/>
                                    <tr>
                                        <td>
                                            <a href="{$mappingNodeVul}">
                                                <xsl:value-of select="dc:name"/>
                                            </a>
                                        </td>
                                        <td>
                                            <xsl:value-of select="dc:cvssScore"/>
                                        </td>
                                        <td>
                                            <xsl:value-of select="dc:severity"/>
                                        </td>
                                        <td>
                                            ...
                                            <div class="cpe">
                                                <span onclick="openDetailed(this)" class="sum">
                        ...
                        <div>
                            ...
                            <table>
                                ...
                                <xsl:for-each select="dc:vulnerabilities/dc:suppressedVulnerability">
                                    <xsl:sort select="dc:cvssScore" order="descending"/>
                                    <xsl:variable name="mappingNodeSupVul"
                                                  select="concat('https://cve.mitre.org/cgi-bin/cvename.cgi?name=',dc:name)"/>

                                    <tr>
                                        <td>
                                            <a href="{$mappingNodeSupVul}">
                                                <xsl:value-of select="dc:name"/>
                                            </a>
                                        </td>
                                        <td>
