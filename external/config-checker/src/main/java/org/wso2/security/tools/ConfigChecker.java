 ...
 */
package org.wso2.security.tools;
...
import org.wso2.security.tools.model.report.Result;
import org.wso2.security.tools.parser.ConfigurationParser;
import org.wso2.security.tools.report.ReportGenerator;
import org.wso2.security.tools.utils.Utils;
import org.wso2.security.tools.utils.XMLParser;
...
import static org.wso2.security.tools.utils.Constants.PRESENT_DIRECTORY;
...
public class ConfigChecker {
    ...
    public static void main(String[] args) {
        ...
        String applicationPath = Paths.get(PRESENT_DIRECTORY).toAbsolutePath().normalize().toString();
    ...
    private static List<ConfigElement> compareConfigFiles(String refConfigFilePath, String productConfigFilePath,
        ...
        try {
            ...
            throw new ConfigCheckerException("Error occurred while parsing the configurations. " + e.getMessage(), e);
        }
        return configElementsResultList;
    }

    /**
     * This method is used to compare all the paren configurations.
     *
    ...
    private static HashMap<String, List<ConfigElement>> compareChildAndParentConfigurations(
        ...
        try {
            for (ChildProperty childProperty : childPropertyList) {
                ...
                parentConfigElementsResultList = compareConfigFiles(parentConfigProperty.getRefParentConfigFilePath(),
                        childProperty.getProductConfigFilePath(),
